...
import { getInitialsFromName, inferInitialsFromEmail } from './helpers'

const sizeMap = { xs: 20, sm: 24, md: 36, lg: 48 } as const

/**
 * Ported from Kan apps/web/src/components/Avatar.tsx. next/image → plain <img>
 * (Reflect is Vite, not Next); everything else is verbatim.
 */
const Avatar = ({
  size = 'md',
  name,

...
export const notifications = pgTable(
  ...
  (table) => [
    index("gsd_notification_user_deleted_idx").on(
      table.userId,
      table.deletedAt,
    ),
    index("gsd_notification_user_read_deleted_idx").on(
      table.userId,
      table.readAt,
      table.deletedAt,
    ),
    index("gsd_notification_user_type_card_idx").on(
      table.userId,
      table.type,
      table.cardId,
    ),
    index("gsd_notification_user_type_workspace_idx").on(
      table.userId,
      table.type,
      table.workspaceId,
    ),
    index("gsd_notification_user_created_idx").on(
      table.userId,
      table.createdAt,
    ),
  ],

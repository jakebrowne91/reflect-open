  ...
  byId: protectedProcedure
    ...
    .input(
      z.object({
        ...
        sources: z
          .array(z.enum(["email", "slack", "emma", "sentry"]))
          .optional(),
        dueDateFilters: z
          .array(
            z.enum([
          ...
          .optional(),
        supportUserId: z.string().trim().min(1).max(200).optional(),
        sourceSystem: z.string().trim().min(1).max(80).optional(),
        sourceChannel: z.string().trim().min(1).max(80).optional(),
        reportedFrom: z.date().optional(),
        reportedTo: z.date().optional(),
